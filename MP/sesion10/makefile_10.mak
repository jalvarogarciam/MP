...
all: \
	...
	$(BIN)/IV_Demo_Operadores-Corredores \
	fin-ejecutables
...
$(BIN)/IV_Demo_Operadores-Corredores : $(OBJ)/IV_Demo_Operadores-Corredores.o \
							 $(LIB)/libCorredor.a $(LIB)/libCorredores.a

	@echo
	@echo Creando ejecutable: IV_Demo_Operadores-Corredores
	@echo
	g++ -o $(BIN)/IV_Demo_Operadores-Corredores \
				$(OBJ)/IV_Demo_Operadores-Corredores.o \
...
$(OBJ)/IV_Demo-Matriz2D.o : $(SRC)/IV_Demo-Matriz2D.cpp \
	...
	@echo
	@echo Creando objeto: IV_Demo-Matriz2D
	@echo
	g++ -c -g -o $(OBJ)/IV_Demo-Matriz2D.o \
				$(SRC)/IV_Demo-Matriz2D.cpp\
		 		-I$(INCLUDE) -std=c++11


$(OBJ)/IV_Demo_Operadores-Corredores.o : \
							$(SRC)/IV_Demo_Operadores-Corredores.cpp \
							$(INCLUDE)/Corredor.h \
							$(INCLUDE)/Corredores.h 
	@echo
	@echo Creando ejecutable: IV_Demo_Operadores-Corredores.o
	@echo
	g++ -c -g -o $(OBJ)/IV_Demo_Operadores-Corredores.o \
				 $(SRC)/IV_Demo_Operadores-Corredores.cpp \
				 -I$(INCLUDE) -std=c++11
...
clean-objs:
	...
	-rm $(OBJ)/IV_Demo_Operadores-Corredores.o
	-rm $(OBJ)/Matriz2D.o
	-rm $(OBJ)/Fecha.o
	-rm $(OBJ)/Corredores.o
	-rm $(OBJ)/Corredor.o
...
clean-bins :
	...
	-rm $(BIN)/IV_Demo_Operadores-Corredores
	@echo ...Borrados
	@echo
clean-lib:
