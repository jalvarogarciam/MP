...
//
// Declaración de la clase Secuencia (versión 3).
// Incluye: 
...
public:
    ...
    string ToString (const char * const msg="") const;

    /***********************************************************************/
    // Operadores de E/S

    // Inserta en un flujo de texto un objeto "Secuencia".
    friend ostream & operator << (ostream & out, const Secuencia & s);

    // Lee los datos de un objeto "Secuencia" desde un flujo de texto.
    friend istream & operator >> (istream & in, Secuencia & s);
    ...
    void EscribirSecuencia (const char *nombre) const;
    void LeerSecuencia     (const char *nombre);
...
private:
    ...
    /***********************************************************************/
    // Rellena una "Secuencia" con los datos del fichero "nombre".
